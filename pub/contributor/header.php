...
if(empty($_SESSION['login']) || intval($_SESSION['login']) != 6) {
...
$st = $conn->prepare("SELECT * from contributors c,users u WHERE c.id_contributor=u.id_profile AND u.id_user=:IDA");
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="user-profile" >
                    <div class="user-pro-body">
                        <div class="dropdown">
                            <span style="color: white"><?= $account->pseudo ?></span>
                            ...
                            <div class="dropdown-menu animated flipInY">
                                <!-- text-->
                                <a href="my_profile.php?tab=application_settings"class="dropdown-item"><i class="mdi mdi-cog"></i> <?php echo ($trans["settings"])?></a>
                                <!-- text-->
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="waves-effect waves-dark" href="Add_leads.php"aria-expanded="false"><i class="mdi mdi-layout"></i><span class="hide-menu"><?= $trans['Add_leads']?></span></a>
                        </li>
                        <li> <a class="waves-effect waves-dark" href="reportings.php"aria-expanded="false"><i class="mdi mdi-chart-areaspline"></i><span class="hide-menu"><?= $trans['reportings']?></span></a>
                        </li>
                    </ul>
                </nav>
