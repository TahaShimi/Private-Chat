            ...
            if(isset($_POST['valider'])){
                if(!isset($_POST['password']) || !isset($_POST['password_confirmation'])){
                    ...
                    if($stmt2->execute()){
                        ...
                        if($stmt3->execute()){
                            header('Location: index.php?cde=200');
                            exit();
                        }
                        else{
                            $msgR = "Error";
                    ...
                    <div class="container" id="container">
                        <div class="form-container sign-in-container">
                            <form  id="loginform" action="" method="POST">
                                <h1><?php echo utf8_encode($trans["index"]["reset_password"])?></h1>
                                <span></span>
                                ...
                                <button type="submit" name="valider" ><?php echo utf8_encode($trans["index"]["save_password"])?></button>
